      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-8 sm:gap-12">
            ...
            />
            <Image src="/images/partners/aws.png" alt="AWS" width={150} height={60} className="h-12 w-auto" />
            <Image
            ...
            <Image
              ...
              className="h-12 w-auto"
            />
            <Image src="/images/partners/oracle.png" alt="Oracle" width={150} height={60} className="h-12 w-auto" />
            <Image src="/images/partners/cisco.png" alt="Cisco" width={150} height={60} className="h-12 w-auto" />
          </div>
        </div>
      </section>
    </main>
